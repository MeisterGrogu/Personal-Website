...
const Mail = ({ isMaximized }) => {
  ...
  const submitHandler = (e) => {
    ...
    if (
      ...
      setNotification(
        <>
          <span className=" text-red-600 pe-1">&#10006;</span> ungültige Mail Adresse!
        </>
      );
      setNotify(true);
      setTimeout(() => {
    ...
    emailjs
      ...
      .then((result) => {
        ...
        setNotification(
          <>
            <span className=" text-green-600 pe-1">&#10003;</span> Mail erfolgreich gesendet!
          </>
        );
        setNotify(true);
        setTimeout(() => {
      ...
      >
        ...
        <div className=" bg-white border-b-[2px] border-b-[#4d4c4c] m-[2px] p-[10px] flex justify-start gap-[5px] text-[18px] items-center">
          ...
          <input
            ...
            type="text"
            readOnly
            value={"kontakt@leopold-peters.de"}
        ...
        <div className=" flex justify-center m-[5px] p-[5px] pb-[10px]">
          ...
          >
            ...
            /> */}
            {isLoading ? (
              <span className=" text-gray-600">Senden...</span>
            ) : (
              <span>Senden</span>
            )}
          </button>
